...
// intComs_gamemodeMakeKeys and save-persistent, the same Key family the doors use. The Key is
// declared on actor_save_C, not on this class, so EnsureResolved resolves it against
// actor_save_C, its declaring class.
