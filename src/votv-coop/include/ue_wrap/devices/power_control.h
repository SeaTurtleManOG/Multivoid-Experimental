...
//
// Identity = the inherited AtriggerBase_C::Key (save-persistent, cross-peer stable; Key resolves
// against triggerBase_C, its declaring class, the same pattern the door follows). The base power
// EFFECTS (servers/doors/lightRoots)
